...
export const dhiHairTransplantClinical = {
  ...
  realisticOutcomes: t("A successful DHI hair transplant yields a graft survival rate of approximately 90% to 95% when performed by experienced practitioners under strict clinical conditions. The final result is designed to provide a natural hairline design, with graft angles and density (typically 40-50 grafts per cm²) that blend seamlessly with your native hair. Results are visible starting at 3-4 months, with full density and texture maturation achieved between 12 and 15 months post-procedure."),
