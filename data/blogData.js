export const blogPosts = [
  {
    ...
    metaTitle: { en: "Latest Medical Insights on evolution sapphire fue | Meva Clinic Blog", ro: "Ultimele Noutăți Medicale despre evolution sapphire fue | Blog Meva Clinic" },
    metaDesc: { en: "Read the latest medical articles about evolution sapphire fue from top specialists at Meva Clinic Turkey. Stay informed on cutting-edge treatments.", ro: "Citește cele mai recente articole medicale despre evolution sapphire fue scrise de specialiști de top de la Meva Clinic Turcia. Fii la curent cu tratamentele de ultimă generație." },
    keywords: { en: ["evolution sapphire fue", "meva clinic blog", "medical tourism turkey"], ro: ["evolution sapphire fue", "blog meva clinic", "turism medical turcia"] },
    category: "Hair Tech",
  ...
  },
  {
    ...
    metaTitle: { en: "Latest Medical Insights on cyberknife s7 oncology | Meva Clinic Blog", ro: "Ultimele Noutăți Medicale despre cyberknife s7 oncology | Blog Meva Clinic" },
    metaDesc: { en: "Read the latest medical articles about cyberknife s7 oncology from top specialists at Meva Clinic Turkey. Stay informed on cutting-edge treatments.", ro: "Citește cele mai recente articole medicale despre cyberknife s7 oncology scrise de specialiști de top de la Meva Clinic Turcia. Fii la curent cu tratamentele de ultimă generație." },
    keywords: { en: ["cyberknife s7 oncology", "meva clinic blog", "medical tourism turkey"], ro: ["cyberknife s7 oncology", "blog meva clinic", "turism medical turcia"] },
    category: "Oncology",
  ...
  },
  {
    ...
    metaTitle: { en: "Latest Medical Insights on exosome therapy healing | Meva Clinic Blog", ro: "Ultimele Noutăți Medicale despre exosome therapy healing | Blog Meva Clinic" },
    metaDesc: { en: "Read the latest medical articles about exosome therapy healing from top specialists at Meva Clinic Turkey. Stay informed on cutting-edge treatments.", ro: "Citește cele mai recente articole medicale despre exosome therapy healing scrise de specialiști de top de la Meva Clinic Turcia. Fii la curent cu tratamentele de ultimă generație." },
    keywords: { en: ["exosome therapy healing", "meva clinic blog", "medical tourism turkey"], ro: ["exosome therapy healing", "blog meva clinic", "turism medical turcia"] },
  ...
  },
  {
    ...
    metaTitle: { en: "Latest Medical Insights on jci standards importance | Meva Clinic Blog", ro: "Ultimele Noutăți Medicale despre jci standards importance | Blog Meva Clinic" },
    metaDesc: { en: "Read the latest medical articles about jci standards importance from top specialists at Meva Clinic Turkey. Stay informed on cutting-edge treatments.", ro: "Citește cele mai recente articole medicale despre jci standards importance scrise de specialiști de top de la Meva Clinic Turcia. Fii la curent cu tratamentele de ultimă generație." },
    keywords: { en: ["jci standards importance", "meva clinic blog", "medical tourism turkey"], ro: ["jci standards importance", "blog meva clinic", "turism medical turcia"] },
    category: "Safety",
    image: "/images/hospital.webp",
    title: {
  ...
  },
  {
    ...
    metaTitle: { en: "Latest Medical Insights on post op logistics istanbul | Meva Clinic Blog", ro: "Ultimele Noutăți Medicale despre post op logistics istanbul | Blog Meva Clinic" },
    metaDesc: { en: "Read the latest medical articles about post op logistics istanbul from top specialists at Meva Clinic Turkey. Stay informed on cutting-edge treatments.", ro: "Citește cele mai recente articole medicale despre post op logistics istanbul scrise de specialiști de top de la Meva Clinic Turcia. Fii la curent cu tratamentele de ultimă generație." },
    keywords: { en: ["post op logistics istanbul", "meva clinic blog", "medical tourism turkey"], ro: ["post op logistics istanbul", "blog meva clinic", "turism medical turcia"] },
    category: "Concierge",
  ...
  },
  {
    ...
    metaTitle: { en: "Latest Medical Insights on bariatric precision robotics | Meva Clinic Blog", ro: "Ultimele Noutăți Medicale despre bariatric precision robotics | Blog Meva Clinic" },
    metaDesc: { en: "Read the latest medical articles about bariatric precision robotics from top specialists at Meva Clinic Turkey. Stay informed on cutting-edge treatments.", ro: "Citește cele mai recente articole medicale despre bariatric precision robotics scrise de specialiști de top de la Meva Clinic Turcia. Fii la curent cu tratamentele de ultimă generație." },
    keywords: { en: ["bariatric precision robotics", "meva clinic blog", "medical tourism turkey"], ro: ["bariatric precision robotics", "blog meva clinic", "turism medical turcia"] },
    category: "Bariatric",
  ...
  },
  {
    ...
    metaTitle: { en: "Latest Medical Insights on dental 3d smile design | Meva Clinic Blog", ro: "Ultimele Noutăți Medicale despre dental 3d smile design | Blog Meva Clinic" },
    metaDesc: { en: "Read the latest medical articles about dental 3d smile design from top specialists at Meva Clinic Turkey. Stay informed on cutting-edge treatments.", ro: "Citește cele mai recente articole medicale despre dental 3d smile design scrise de specialiști de top de la Meva Clinic Turcia. Fii la curent cu tratamentele de ultimă generație." },
    keywords: { en: ["dental 3d smile design", "meva clinic blog", "medical tourism turkey"], ro: ["dental 3d smile design", "blog meva clinic", "turism medical turcia"] },
  ...
  },
  {
    ...
    metaTitle: { en: "Latest Medical Insights on immunotherapy breakthroughs | Meva Clinic Blog", ro: "Ultimele Noutăți Medicale despre immunotherapy breakthroughs | Blog Meva Clinic" },
    metaDesc: { en: "Read the latest medical articles about immunotherapy breakthroughs from top specialists at Meva Clinic Turkey. Stay informed on cutting-edge treatments.", ro: "Citește cele mai recente articole medicale despre immunotherapy breakthroughs scrise de specialiști de top de la Meva Clinic Turcia. Fii la curent cu tratamentele de ultimă generație." },
    keywords: { en: ["immunotherapy breakthroughs", "meva clinic blog", "medical tourism turkey"], ro: ["immunotherapy breakthroughs", "blog meva clinic", "turism medical turcia"] },
    category: "Oncology",
  ...
  },
  {
    ...
    metaTitle: { en: "Latest Medical Insights on anesthesia safety protocols | Meva Clinic Blog", ro: "Ultimele Noutăți Medicale despre anesthesia safety protocols | Blog Meva Clinic" },
    metaDesc: { en: "Read the latest medical articles about anesthesia safety protocols from top specialists at Meva Clinic Turkey. Stay informed on cutting-edge treatments.", ro: "Citește cele mai recente articole medicale despre anesthesia safety protocols scrise de specialiști de top de la Meva Clinic Turcia. Fii la curent cu tratamentele de ultimă generație." },
    keywords: { en: ["anesthesia safety protocols", "meva clinic blog", "medical tourism turkey"], ro: ["anesthesia safety protocols", "blog meva clinic", "turism medical turcia"] },
    category: "Safety",
    image: "/images/hospital.webp",
    title: {
  ...
  },
  {
    ...
    metaTitle: { en: "Latest Medical Insights on organ transplant ethics excellence | Meva Clinic Blog", ro: "Ultimele Noutăți Medicale despre organ transplant ethics excellence | Blog Meva Clinic" },
    metaDesc: { en: "Read the latest medical articles about organ transplant ethics excellence from top specialists at Meva Clinic Turkey. Stay informed on cutting-edge treatments.", ro: "Citește cele mai recente articole medicale despre organ transplant ethics excellence scrise de specialiști de top de la Meva Clinic Turcia. Fii la curent cu tratamentele de ultimă generație." },
    keywords: { en: ["organ transplant ethics excellence", "meva clinic blog", "medical tourism turkey"], ro: ["organ transplant ethics excellence", "blog meva clinic", "turism medical turcia"] },
    category: "Transplant",
    image: "/images/hospital.webp",
    title: {
  ...
  // ─── IVF Cornerstone Articles ────────────────────────────────────────────────
  {
    ...
    metaTitle: { en: "Latest Medical Insights on ivf success rates cyprus 2026 | Meva Clinic Blog", ro: "Ultimele Noutăți Medicale despre ivf success rates cyprus 2026 | Blog Meva Clinic" },
    metaDesc: { en: "Read the latest medical articles about ivf success rates cyprus 2026 from top specialists at Meva Clinic Turkey. Stay informed on cutting-edge treatments.", ro: "Citește cele mai recente articole medicale despre ivf success rates cyprus 2026 scrise de specialiști de top de la Meva Clinic Turcia. Fii la curent cu tratamentele de ultimă generație." },
    keywords: { en: ["ivf success rates cyprus 2026", "meva clinic blog", "medical tourism turkey"], ro: ["ivf success rates cyprus 2026", "blog meva clinic", "turism medical turcia"] },
    category: "IVF",
...

  {
    ...
    metaTitle: { en: "Latest Medical Insights on ovarian prp low amh treatment | Meva Clinic Blog", ro: "Ultimele Noutăți Medicale despre ovarian prp low amh treatment | Blog Meva Clinic" },
    metaDesc: { en: "Read the latest medical articles about ovarian prp low amh treatment from top specialists at Meva Clinic Turkey. Stay informed on cutting-edge treatments.", ro: "Citește cele mai recente articole medicale despre ovarian prp low amh treatment scrise de specialiști de top de la Meva Clinic Turcia. Fii la curent cu tratamentele de ultimă generație." },
    keywords: { en: ["ovarian prp low amh treatment", "meva clinic blog", "medical tourism turkey"], ro: ["ovarian prp low amh treatment", "blog meva clinic", "turism medical turcia"] },
    category: "IVF",
    image: "/images/blog/ivf-premium.png",
    title: {
  ...
  },
  {
    ...
    metaTitle: { en: "Latest Medical Insights on ngs ai embryo selection ivf | Meva Clinic Blog", ro: "Ultimele Noutăți Medicale despre ngs ai embryo selection ivf | Blog Meva Clinic" },
    metaDesc: { en: "Read the latest medical articles about ngs ai embryo selection ivf from top specialists at Meva Clinic Turkey. Stay informed on cutting-edge treatments.", ro: "Citește cele mai recente articole medicale despre ngs ai embryo selection ivf scrise de specialiști de top de la Meva Clinic Turcia. Fii la curent cu tratamentele de ultimă generație." },
    keywords: { en: ["ngs ai embryo selection ivf", "meva clinic blog", "medical tourism turkey"], ro: ["ngs ai embryo selection ivf", "blog meva clinic", "turism medical turcia"] },
    category: "IVF",
    image: "/images/blog/ivf-premium.png",
    title: {
...

  {
    ...
    metaTitle: { en: "Latest Medical Insights on istanbul to cyprus ivf travel guide | Meva Clinic Blog", ro: "Ultimele Noutăți Medicale despre istanbul to cyprus ivf travel guide | Blog Meva Clinic" },
    metaDesc: { en: "Read the latest medical articles about istanbul to cyprus ivf travel guide from top specialists at Meva Clinic Turkey. Stay informed on cutting-edge treatments.", ro: "Citește cele mai recente articole medicale despre istanbul to cyprus ivf travel guide scrise de specialiști de top de la Meva Clinic Turcia. Fii la curent cu tratamentele de ultimă generație." },
    keywords: { en: ["istanbul to cyprus ivf travel guide", "meva clinic blog", "medical tourism turkey"], ro: ["istanbul to cyprus ivf travel guide", "blog meva clinic", "turism medical turcia"] },
    category: "IVF",
    image: "/images/vip-transfer.jpg",
    title: {
