...
export const categoryHubData: Record<string, CategoryData> = {
  ...
  hair: {
    ...
    description: {
      en: 'Meva Clinic offers world-leading hair restoration facilities in Istanbul, Turkey, using cutting-edge microscopic follicular unit extraction methods. We specialize in Sapphire FUE, Direct Hair Implantation (DHI), and specialized eyebrow and beard transplants. Sapphire FUE utilizes micro-blades crafted from single-crystal sapphire, creating V-shaped micro-channels that minimize scalp tissue trauma, reduce bleeding, and accelerate post-operative healing by 40% compared to traditional steel slits. For patients seeking density planning based on donor capacity without shaving their recipient areas, our Direct Hair Implantation (DHI) technique utilizes custom Choi Implanter Pens, allowing for simultaneous channel creation and graft insertion with precise depth, angle, and direction control. Additionally, our premium packages integrate advanced Exosome therapy—a cell-free regenerative protocol utilizing purified stem cell exosomes to stimulate follicular regeneration and designed to support strong graft retention through careful handling and aftercare. We support international patients with premium all-inclusive concierge arrangements: airport pick-ups via VIP Mercedes-Benz transfers, luxury 5-star hotel accommodations near the clinical locations, and native translators who ensure seamless communication with your surgical specialists.',
