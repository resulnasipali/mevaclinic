...
export const categoryHubData: Record<string, CategoryData> = {
  bariatric: {
    ...
    faq: {
      en: [
        ...
        { q: 'When can I fly home after weight loss surgery in Istanbul?', a: 'We require a minimum stay of 5 to 7 days in Istanbul. A final pre-flight surgical check is conducted on day 5, after which it is fitness to fly is confirmed individually after surgical review.' }
      ],
      ro: [
  ...
  hair: {
    ...
    description: {
      en: 'Meva Clinic supports international patients with access to specialized clinical care in hair restoration in Istanbul, Turkey, utilizing advanced microscopic follicular unit extraction methods. The clinical partner network specializes in Sapphire FUE, Direct Hair Implantation (DHI), and restorative eyebrow and beard transplants. Sapphire FUE utilizes micro-blades crafted from single-crystal sapphire to create precise micro-channels, minimizing scalp tissue trauma and supporting the natural healing process. For patients requiring localized density planning without shaving the recipient area, the DHI technique utilizes Choi Implanter Pens for simultaneous channel creation and graft insertion, enabling precise control over depth, angle, and direction. Treatment planning is guided by individual donor area assessment, hairline planning, and graft strategy. Adjunctive regenerative support, such as exosome-based therapy, may be considered when medically suitable. We coordinate medical translation, professional transport, and accommodations to ensure a seamless experience for international patients.',
      ro: 'Meva Clinic oferă unități de restaurare capilară de top în Istanbul, utilizând metode avansate de extracție a unităților foliculare microscopice. Suntem specializați în Sapphire FUE, Direct Hair Implantation (DHI) și transplanturi specializate de sprâncene și barbă. Sapphire FUE folosește micro-lame din safir monocristal, creând micro-canale în formă de V care utilizează micro-lame din safir pentru a crea micro-canale precise, reducând trauma scalpului și susținând procesul natural de vindecare în comparație cu lamele de oțel tradiționale. Pentru pacienții care doresc o densitate maximă fără a fi nevoiți să își radă complet părul, tehnica DHI utilizează stilouri Choi, permițând crearea canalului și introducerea grefei simultan, cu un control precis al unghiului și direcției de creștere. Integrăm în pachetele premium terapia cu exozomi - un protocol regenerativ avansat bazat pe celule stem pentru a stimula foliculii și a crește rata de prindere a grefelor la un nivel optim. Oferim asistență completă de coordonare: preluare de la aeroport cu transfer privat, cazare la hoteluri premium și traducători personali pe tot parcursul procedurilor.',
      de: 'Die Meva Clinic bietet weltweit führende Einrichtungen zur Haarwiederherstellung in Istanbul, Türkei, unter Anwendung modernster mikroskopischer Follicular Unit Extraction-Methoden. Wir sind auf Saphir-FUE, Direct Hair Implantation (DHI) sowie spezielle Augenbrauen- und Barttransplantationen spezialisiert. Saphir-FUE verwendet Mikroklingen aus Einkristall-Saphir, die V-förmige Mikrokanäle erzeugen. Dies verwendet Mikroklingen aus Einkristall-Saphir zur Erstellung präziser Mikrokanäle, was dazu beiträgt, das Trauma des Kopfhautgewebes zu verringern und den natürlichen Heilungsprozess im Vergleich zu herkömmlichen Stahlschlitzen zu unterstützen. Für Patienten, die maximale Dichte wünschen, ohne den Empfängerbereich rasieren zu müssen, nutzt unsere DHI-Technik spezielle Choi-Implanter-Pens. Dies ermöglicht die gleichzeitige Kanalerstellung und Platzierung der Transplantate mit präziser Kontrolle über Tiefe, Winkel und Richtung. Darüber hinaus integrieren unsere Premium-Pakete die fortschrittliche Exosomen-Therapie – ein zellfreies regeneratives Protokoll, das gereinigte Stammzell-Exosomen nutzt, um die Follikelregeneration zu stimulieren und die Überlebensrate der Haartransplantate auf ein optimales Niveau zu steigern. Wir unterstützen internationale Patienten mit Premium-Koordinationsleistungen: private Transfers, Premium-Partnerhotelunterkünfte und muttersprachliche Dolmetscher.',
      es: 'Meva Clinic ofrece centros de restauración capilar líderes en el mundo en Estambul, Turquía, utilizando métodos avanzados de extracción de unidades foliculares microscópicas. Nos especializamos en Sapphire FUE, Implantación Directa de Cabello (DHI) y trasplantes especializados de cejas y barba. Sapphire FUE utiliza microhojas fabricadas a partir de zafiro monocristalino, creando microcanales en forma de V que utiliza microhojas de zafiro para crear microcanales precisos, lo que ayuda a reducir el trauma del cuero cabelludo y a apoyar el proceso de curación natural en comparación con las hojas de acero tradicionales. Para los pacientes que buscan la máxima densidad sin afeitarse las áreas receptoras, nuestra técnica DHI utiliza Choi Implanter Pens personalizados, lo que permite la creación simultánea de canales y la inserción de injertos con un control preciso de la profundidad, el ángulo y la dirección. Además, nuestros paquetes premium integran la terapia avanzada de exosomas, un protocolo regenerativo libre de células que utiliza exosomas purificados de células madre para estimular la regeneración folicular y aumentar las tasas de supervivencia de los injertos capilares a niveles óptimos. Respaldamos a los pacientes internacionales con arreglos de coordinación premium de pacientes: traslados privados, hoteles asociados premium y traductores nativos.',
      it: 'Meva Clinic offre strutture per il trapianto di capelli leader a livello mondiale a Istanbul, in Turchia, utilizzando metodi microscopici avanzati di estrazione delle unità follicolari. Siamo specializzati in Sapphire FUE, Direct Hair Implantation (DHI) e trapianti specifici di sopracciglia e barba. La tecnica Sapphire FUE utilizza micro-lame in zaffiro monocristallino, creando micro-canali a V che utilizza micro-lame in zaffiro per creare micro-canali precisi, contribuendo a ridurre il trauma del cuoio capelluto e a supportare il naturale processo di guarigione rispetto alle tradizionali lame in acciaio. Per i pazienti che desiderano la massima densità senza radere la zona ricevente, la nostra tecnica DHI utilizza speciali Choi Implanter Pen, consentendo la creazione del canale e l\'inserimento del bulbo contemporaneamente con un controllo preciso di profondità, angolo e direzione. Inoltre, i nostri pacchetti includono la terapia avanzata con esosomi, un protocollo rigenerativo che utilizza esosomi purificati da cellule staminali per stimolare la rigenerazione dei follicoli e aumentare la sopravvivenza dei bulbi a livelli ottimali. Assistiamo i pazienti con servizi premium di coordinazione: trasferimenti privati, hotel convenzionati premium e traduttori dedicati in lingua madre.',
      fr: 'Meva Clinic propose des centres de restauration capillaire de premier plan à Istanbul, en Turquie, en utilisant des méthodes d\'extraction d\'unités folliculaires microscopiques de pointe. Nous sommes spécialisés dans le Sapphire FUE, l\'implantation directe de cheveux (DHI) et les greffes de sourcils et de barbe. La Sapphire FUE utilise des micro-lames en saphir, créant des micro-canaux en V qui utilise des micro-lames en saphir pour créer des micro-canaux précis, aidant à réduire le traumatisme du cuir chevelu et à soutenir le processus naturel de cicatrisation par rapport aux lames en acier traditionnelles. Pour les patients qui recherchent une densité maximale sans raser la zone donneuse, notre technique DHI utilise des stylos implanteurs Choi, permettant la création simultanée de canaux et l\'insertion des greffons. Nos forfaits premium intègrent la thérapie par exosomes, un protocole de régénération cellulaire stimulant la repousse et augmentant le taux de survie des greffons à des niveaux optimaux.',
      ru: 'Meva Clinic предлагает ведущие мировые центры восстановления волос в Стамбуле, Турция, использующие передовые методы микроскопической экстракции фолликулярных объединений. Мы специализируемся на технологиях Sapphire FUE, Direct Hair Implantation (DHI), а также на пересадке бровей и бороды. Метод Sapphire FUE использует микролезвия из монокристаллического сапфира, создающие V-образные микроканалы, что использует микролезвия из сапфира для создания точных микроканалов, помогая снизить травматизацию кожи головы и поддерживать естественный процесс заживления по сравнению с традиционными стальными лезвиями. Для пациентов, желающих получить максимальную густоту без бритья донорской зоны, метод DHI использует специальные имплантеры Choi Implanter Pens, позволяющие одновременно создавать канал и вживлять графт с точным контролем глубины, угла и направления роста. Наши премиум-пакеты также включают экзосомную терапию — протокол регенерации с использованием очищенных экзосом стволовых клеток для стимуляции фолликулов и повышения выживаемости графтов до оптимального уровня.'
    },
    suitabilityTitle: {
  ...
  specialist: {
    ...
    subtitle: {
      en: 'Elite clinical solutions in oncology robotic radiosurgery, specialist organ transplantation coordination, and dynamic IVF therapies.',
    ...
    faq: {
      en: [
        { q: 'Is CyberKnife S7 treatment performed as an outpatient procedure?', a: 'Yes, CyberKnife is a non-surgical option, typically performed without general anesthesia under strict clinical monitoring, and is performed as an outpatient day-procedure. You can return to your hotel immediately after the session.' },
        { q: 'What is the success rate for Cyprus donor IVF packages?', a: 'At our Northern Cyprus partner branches, live-birth success rates for egg donation protocols vary depending on individual clinical factors.' }
      ],
      ro: [
        { q: 'Tratamentul CyberKnife S7 se efectuează în regim ambulatoriu?', a: 'Da, CyberKnife este o optiune non-chirurgicala, efectuata de obicei fara anestezie generala și se efectuează în ambulatoriu. Vă puteți întoarce la hotel imediat după sesiune.' },
        { q: 'Care este rata de succes pentru pachetele FIV cu donator în Cipru?', a: 'La clinicile noastre partenere din Cipru de Nord, rezultatele raportate variază în funcție de vârstă, calitatea embrionului, protocolul de donare și istoricul medical.' }
      ],
      de: [
      ...
      es: [
        { q: '¿El tratamiento con CyberKnife S7 se realiza de forma ambulatoria?', a: 'Sí, CyberKnife es una opcion no quirurgica, realizada sin anestesia general y se realiza como un procedimiento ambulatorio. Puede regresar a su hotel inmediatamente después de la sesión.' },
        { q: '¿Cuál es la tasa de éxito de los paquetes de FIV con donante en Chipre?', a: 'En nuestras clínicas asociadas del norte de Chipre, los resultados reportados varían según la edad, la calidad del embrión, el protocolo del donante y el historial médico.' }
      ],
      it: [
        { q: 'Il trattamento CyberKnife S7 viene eseguito in regime ambulatoriale?', a: 'Sì, CyberKnife è una tecnologia non chirurgica, eseguita senza anestesia generale e viene eseguita in day hospital. È possibile tornare in hotel subito dopo la seduta.' },
      ...
      ru: [
        ...
        { q: 'Какова вероятность успеха программ ЭКО с донорской яйцеклеткой на Кипре?', a: 'В наших партнерских клиниках на Северном Кипре показатели рождения живых детей при использовании донорских яйцеклеток варьируются в зависимости от возраста, качества эмбриона, протокола донорства и истории болезни.' }
      ]
    }
  }
};
