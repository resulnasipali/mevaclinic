...
const PAGE_T: Record<string, Record<string, string>> = {
  ...
  philosophyBody: {
    en: "Navigating an unfamiliar healthcare system in a foreign country can be daunting. Hospitals represent their own interests; Meva Clinic represents YOU. We act as an independent quality filter. We do not own hospitals; instead, we perform structured reviews of selected partner hospital and provider standards. We strictly facilitate medical journeys through accredited partner hospital pathways, including JCI-accredited institutions where applicable, and collaborate exclusively with high-volume, board-certified surgeons who meet the rigorous 'Meva Precision Standard'. From pre-consultation to your long-term follow-up support, our priority is your safety, comfort, and elite medical outcome.",
    ro: "Navigarea într-un sistem de sănătate necunoscut într-o țară străină poate fi copleșitoare. Spitalele își reprezintă propriile interese; Meva Clinic te reprezintă pe TINE. Acționăm ca un filtru independent de calitate. Nu deținem spitale; în schimb, efectuăm evaluări structurate ale standardelor spitalelor și furnizorilor parteneri selectați. Facilităm exclusiv călătoriile medicale prin căi spitalicești partenere acreditate, inclusiv instituții acreditate JCI acolo unde este aplicabil, și colaborăm numai cu chirurgi care îndeplinesc standardul riguros 'Meva Precision Standard'. De la pre-consultare până la suportul de urmărire pe termen lung, prioritatea noastră este siguranța, confortul și rezultatul dvs. medical de elită.",
    es: "Navegar por un sistema de salud desconocido en un país extranjero puede ser desalentador. Los hospitales representan sus propios intereses; Meva Clinic lo representa a USTED. Actuamos como un filtro de calidad independiente. No somos dueños de hospitales; en su lugar, realizamos revisiones estructuradas de los estándares de los hospitales y proveedores asociados seleccionados. Facilitamos estrictamente los viajes médicos a través de vías de hospitales asociados acreditados, incluidas las instituciones acreditadas por la JCI cuando corresponda, y colaboramos exclusivamente con cirujanos certificados que cumplen con el riguroso 'Meva Precision Standard'. Desde la consulta previa hasta el apoyo de seguimiento a largo plazo, nuestra prioridad es su seguridad, comodidad y resultado médico de élite.",
    it: "Orientarsi in un sistema sanitario sconosciuto in un paese straniero può essere scoraggiante. Gli ospedali rappresentano i propri interessi; Meva Clinic rappresenta TE. Agiamo come un filtro di qualità indipendente. Non possediamo ospedali; invece, eseguiamo verifiche strutturate degli standard degli ospedali e dei fornitori partner selezionati. Facilitiamo rigorosamente i viaggi medici attraverso percorsi ospedalieri partner accreditati, comprese le istituzioni accreditate JCI ove applicabile, e collaboriamo esclusivamente con chirurghi certificati che soddisfano il rigoroso 'Meva Precision Standard'. Dalla pre-consulenza al supporto di follow-up a lungo termine, la nostra priorità è la vostra sicurezza, il vostro comfort e un risultato medico d'élite.",
    fr: "Naviguer dans un système de santé inconnu dans un pays étranger peut être intimidant. Les hôpitaux représentent leurs propres intérêts ; Meva Clinic vous représente. Nous agissons comme un filtre de qualité indépendant. Nous ne possédons pas d'hôpitaux ; à la place, nous effectuons des examens structurés des normes des hôpitaux et prestataires partenaires sélectionnés. Nous facilitons strictement les parcours médicaux via des réseaux d'hôpitaux partenaires agréés, y compris des établissements accrédités JCI le cas échéant, et collaborons exclusivement avec des chirurgiens certifiés qui répondent à la norme rigoureuse 'Meva Precision Standard'. De la pré-consultation à votre suivi à long terme, notre priorité est votre sécurité, votre confort et un résultat médical d'élite.",
    de: "Sich in einem fremden Gesundheitssystem in einem fremden Land zurechtzufinden, kann entmutigend sein. Krankenhäuser vertreten ihre eigenen Interessen; Meva Clinic vertritt SIE. Wir fungieren als unabhängiger Qualitätsfilter. Wir besitzen keine Krankenhäuser; stattdessen führen wir strukturierte Prüfungen der Standards ausgewählter Partnerkrankenhäuser und -anbieter durch. Wir vermitteln medizinische Reisen ausschließlich über akkreditierte Partnerklinik-Wege, einschließlich JCI-akkreditierter Einrichtungen, sofern zutreffend, und arbeiten ausschließlich mit staatlich geprüften Chirurgen zusammen, die den strengen 'Meva Precision Standard' erfüllen. Von der Vorberatung bis hin zu Ihrer langfristigen Nachsorgeunterstützung stehen Ihre Sicherheit, Ihr Komfort und ein hervorragendes medizinisches Ergebnis an erster Stelle.",
    ru: "Ориентироваться в незнакомой системе здравоохранения в чужой стране может быть непросто. Больницы представляют свои собственные интересы; Meva Clinic представляет ВАС. Мы действуем как независимый фильтр качества. Мы не владеем больницами; вместо этого мы проводим структурированный аудит стандартов выбранных партнерских больниц и поставщиков медицинских услуг. Мы организуем медицинские поездки исключительно через аккредитованные партнерские больничные каналы, включая клиники, аккредитованные JCI, где это применимо, и сотрудничаем с сертифицированными хирургами, соответствующими строгому стандарту «Meva Precision Standard». От предварительной консультации до долгосрочной послеоперационной поддержки наш приоритет — ваша безопасность, комфорт и элитный медицинский результат."
  },
  pillar1Title: {
  ...
  pillar3Body: {
    en: "We don't showcase names for commercial exploitation; we protect the integrity of our medical network. Meva Clinic collaborates only with recognized medical authorities and academic professors who possess a proven track record of extensive international patient experience.",
    ro: "Nu prezentăm nume pentru exploatare comercială; protejăm integritatea rețelei noastre medicale. Meva Clinic colaborează numai cu autorități medicale recunoscute și profesori universitari care dețin o experiență vastă dovedită în tratarea pacienților internaționali.",
    es: "No mostramos nombres para explotación comercial; protegemos la integridad de nuestra red médica. Meva Clinic colabora únicamente con autoridades médicas reconocidas y profesores académicos que poseen una amplia y comprobada experiencia con pacientes internacionales.",
    it: "Non mostriamo nomi a fini di sfruttamento commerciale; proteggiamo l'integrità della nostra rete medica. Meva Clinic collabora solo con autorità mediche riconosciute e professori accademici che vantano una comprovata e vasta esperienza con pazienti internazionali.",
    fr: "Nous ne présentons pas de noms à des fins d'exploitation commerciale ; nous protégeons l'intégrité de notre réseau médical. Meva Clinic collabore uniquement avec des autorités médicales reconnues et des professeurs d'université qui possèdent une vaste expérience éprouvée auprès de patients internationaux.",
    de: "Wir präsentieren keine Namen zur kommerziellen Ausbeutung; wir schützen die Integrität unseres medizinischen Netzwerks. Meva Clinic arbeitet nur mit anerkannten medizinischen Kapazitäten und akademischen Professoren zusammen, die eine nachgewiesene umfassende Erfahrung in der Behandlung internationaler Patienten besitzen.",
    ru: "Мы не публикуем имена в коммерческих целях; мы защищаем репутацию нашей медицинской сети. Meva Clinic сотрудничает только с признанными медицинскими авторитетами и профессорами, обладающими обширным подтвержденным опытом работы с иностранными пациентами."
  },
  pillar4Title: {
    en: "Long-Term Post-Op Care Ecosystem",
    ro: "Ecosistem de Îngrijire Postoperatorie pe Termen Lung",
    es: "Ecosistema de Atención Posoperatoria a Largo Plazo",
    it: "Ecosistema di Assistenza Post-Operatoria a Lungo Termine",
    fr: "Écosystème de Suivi Postopératoire à Long Terme",
    de: "Langfristiges Nachsorge-Ökosystem",
    ru: "Долгосрочное послеоперационное сопровождение"
  },
  pillar4Body: {
