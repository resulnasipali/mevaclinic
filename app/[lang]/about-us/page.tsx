...
const PAGE_T: Record<string, Record<string, string>> = {
  ...
  pillar1Body: {
    ...
    es: "Nos aseguramos de que cada procedimiento bariátrico, de cirugía plástica, dental y de restauración capilar se lleve a cabo únicamente en complejos médicos dinámicos y de vanguardia equipados con tecnologías de diagnóstico avanzadas y soporte de cuidados intensivos a gran escala.",
  ...
  pillar2Body: {
    ...
    fr: "Le tourisme médical est plus qu'une simple opération ; c'est une transition de vie. Nous gérons de manière transparente l'intégralité de votre voyage : transferts aéroport VIP Mercedes-Benz haut de gamme, hébergements en hôtel 5 étoiles, traducteurs personnels en langue maternelle et logistique clinique privée.",
    de: "Medizintourismus ist mehr als eine Operation; es ist ein Übergang im Leben. Wir organisieren Ihre gesamte Reise nahtlos: erstklassige VIP-Flughafentransfers mit Mercedes-Benz, 5-Sterne-Hotelunterkünfte, persönliche Dolmetscher in Ihrer Muttersprache und private klinische Logistik.",
    ru: "Медицинский туризм — это больше, чем просто операция; это новый этап в жизни. Мы полностью организуем ваше путешествие: премиум-трансфер из аэропорта Mercedes-Benz VIP, проживание в 5-звездочном отели, персональные переводчики на ваш родной язык и индивидуальная логистика."
  },
  pillar3Title: {
  ...
  pillar4Body: {
    ...
    es: "Su viaje con Meva Clinic no termina en la puerta del aeropuerto. Nuestros consultores dedicados a la atención posterior internacional se mantienen en contacto constante con usted cuando regresa a casa, garantizando que sus métricas de recuperación sigan los profesionaes clínicos exactos requeridos por sus especialistas tratantes.",
          ...
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center mb-16">
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-accent">
                {tUI("Core Operating Principles", lang)}
              </span>
              <h2 className="text-3xl md:text-4xl font-serif font-bold text-[#0b1626] mt-2">
                {isEn ? "Our Pillars of Facilitation Excellence" : "Pilonii Noștri de Excelență în Facilitare"}
              </h2>
            </div>
            ...
            <div className="bg-[#0b1626] text-white rounded-[3rem] p-8 md:p-16 relative overflow-hidden shadow-2xl border border-white/5">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start gap-8">
                ...
                <div>
                  ...
                  >
                    {tUI("freeConsultation", lang)} <ArrowRight size={16} />
                  </Link>
                </div>
              </div>
            </div>
