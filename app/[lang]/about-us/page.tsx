...
const PAGE_T: Record<string, Record<string, string>> = {
  ...
  pillar2Body: {
    ...
    ru: "Медицинский туризм — это больше, чем просто операция; это новый этап в жизни. Мы полностью организуем ваше путешествие: премиум-трансфер из аэропорта Mercedes-Benz VIP, проживание в 5-звездочном отеле, персональные переводчики на ваш родной язык и индивидуальная логистика."
  },
  pillar3Title: {
