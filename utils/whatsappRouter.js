/**
 * whatsappRouter.js
 * Dynamic WhatsApp Link Builder with Localized Intent Templates
 */
export function getWhatsAppLink(slug, locale) {
  ...
  const messageDict = {
    "gastric-sleeve": {
      "en": "Hello Meva Clinic, I would like to get a personalized quote for Gastric Sleeve Surgery. I am interested in the 4 Nights Premium Hospitalization package with Transparent Pricing.",
      "ro": "Bună Meva Clinic, aș dori să primesc o ofertă personalizată pentru operația de Gastric Sleeve. Sunt interesat(ă) de pachetul cu 4 nopți de spitalizare premium, cu tarife transparente."
    },
    "mommy-makeover": {
      "en": "Hello Meva Clinic, I am interested in the Mommy Makeover package. Could you provide details regarding the dual-surgeon coordination and JCI-accredited partner facilities?",
      "ro": "Bună Meva Clinic, sunt interesată de pachetul Mommy Makeover. Îmi puteți oferi detalii despre coordonarea combinată cu doi chirurgi și facilitățile partenere acreditate JCI?"
    },
    "liposuction-360": {
    ...
    "breast-implants": {
      "en": "Hello Meva Clinic, I am inquiring about Breast Augmentation. I'm specifically interested in your FDA-approved implants with manufacturer warranty support.",
      "ro": "Bună Meva Clinic, doresc informații despre Augmentarea Mamară. Sunt interesată în mod special de implanturile aprobate FDA cu suportul garanției producătorului."
    },
    "gastric-bypass": {
    ...
    "hair-transplant": {
      "en": "Hello Meva Clinic, I am interested in a premium Hair Transplant. Can you share more about the comfort-focused anesthesia option and the long-term growth support?",
      "ro": "Bună Meva Clinic, sunt interesat de un Transplant de Păr premium. Îmi puteți oferi mai multe detalii despre opțiunea de anestezie orientată pe confort și suportul de creștere pe termen lung?"
    }
  };
