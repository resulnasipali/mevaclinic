                    ...
                    <div className="bg-gray-50/50 p-8 px-12 border-t border-gray-100 flex items-center justify-between shrink-0">
                       <div className="flex-1 pr-12">
                         ...
                         <p className="text-xs text-gray-500 leading-relaxed font-medium">
                            {tUI('Meva Clinic supports premium treatments through JCI-accredited partner hospitals in Istanbul, Turkey. All coordination plans include private patient transfers, premium partner hotel accommodation, and dedicated patient care team support with a transparent patient pricing policy.', lang)}
                         </p>
                       </div>
